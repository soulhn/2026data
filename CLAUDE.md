...
- 연도별 운영 규모, 우수 성과 Top 5, 현재 운영 중 과정 테이블 (수강신청/개강인원/제적/중도탈락/현재인원/잔여율)
...
- 매출 분석 관련: `DAILY_TRAINING_FEE = 145_200` (일 훈련비 단가), `REVENUE_FULL_THRESHOLD = 0.80` (전액 청구 최소 출석률)
...
| `pages/1_*.py` | 시장 분석 & 기회 발굴 13탭 (헬퍼 함수 3개, 사업기회 발굴 탭 포함) |
