...
- 보고용 텍스트 (expander) — 지각: 입실시간, 조퇴: 퇴실시간 표시 — 지각: 입실시간, 조퇴: 퇴실시간 표시
...
| `pages/4_*.py` | 시장 동향 분석 13탭 (헬퍼 함수 3개로 중복 제거, 사업기회 발굴 탭 포함) |
| `pages/5_*.py` | 매출 분석 (단위기간별 청구 4탭 + 전체 기수 비교) |
