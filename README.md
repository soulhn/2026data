...
📦 2026data
 ...
 ┃ ┣ 📜 2_🚨_진행과정_관리.py    # [내부] 실시간 출결/위험군 탐지
 ┃ ┣ 📜 3_🔎_데이터_감사.py      # [공통] DB 원본 데이터 조회 (Audit)
 ┃ ┗ 📜 4_📈_시장_동향_분석.py    # [외부] 시장 분석 11개 탭 (교차분석, 시계열, 경쟁, 비용-성과 등)
...
- **Visualization:** Plotly & Altair 인터랙티브 차트
- **시장 분석:** 내부 과정 vs 시장 교차분석, 시계열 트렌드, 경쟁 심화도, 비용-성과 시뮬레이터 (scikit-learn)
