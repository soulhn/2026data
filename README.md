...
> **라이브 데모**: [playdata.streamlit.app](https://playdata.streamlit.app) | **API 명세**: [HRD-Net](./docs/api/hrd_net.md) · [사람인](./docs/api/saramin.md) | **개발 일지**: [DEV_LOG.md](./docs/DEV_LOG.md)
...
- **Testing:** pytest 226개 테스트 (유틸리티, DB 초기화, ETL 함수, 매출 청구 계산, 사람인 ETL, 설정 검증) — push/PR마다 GitHub Actions 자동 실행
