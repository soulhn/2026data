...
with page_error_boundary():
    ...
    st.markdown(
        ...
        "**과정 그룹 + 개강일**이 같으면 같은 기수로 보고, 같은 날 두 기수가 개강하면 회차·기수 번호 순서로 짝짓습니다. "
        "노션은 읽기만 하고 절대 쓰지 않습니다."
    )
...
| N회차 (HRD 회차 번호) | N기 (기수) | 개강일로 맞추고, 같은 날 개강한 기수가 둘이면 번호 순서로 짝지음 (한화 7·8기, SKN 24·25기) |
